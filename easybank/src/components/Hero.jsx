...
const Hero = () => {
  return (
    <section className="bg-background-mobile md:bg-background-desktop md:bg-60 md:bg-desktopPosition bg-no-repeat h-[450px] 2xl:h-[800px] relative z-10">
      <div className="flex flex-col-reverse md:flex-row items-center md:px-32 font-public-sans w-full 2xl:w-[1440px] m-auto">
        <div className="flex flex-col gap-6 -mt-24 md:mt-0 text-center md:text-left md:w-6/12">
        ...
        <img src={ background } alt="Mockups" className='relative -top-[138px] md:top-6 md:left-24 z-0' />
      </div>
    </section> 
  )
}
