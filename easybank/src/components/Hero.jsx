...
const Hero = () => {
  return (
    <section className="bg-background-mobile md:bg-background-desktop bg-contain md:bg-60 md:bg-desktopPosition bg-no-repeat h-[450px] md:h-[600px] relative z-10">
